...
private val sky = mapOf(
        ...
        "CLEAR_NIGHT" to Sky("晴",R.drawable.ic_clear_day,R.drawable.bg_clear_night),
        ...
        "THUNDED_SHOWER" to Sky("雷阵雨",R.drawable.ic_thunder_shower,R.drawable.bg_rain),
        ...
        "MODERATE_HAZE" to Sky("重度雾霾",R.drawable.ic_moderate_haze,R.drawable.bg_fog),
        "HEAVY_HAZE" to Sky("重度雾霾",R.drawable.ic_light_haze,R.drawable.bg_fog),
